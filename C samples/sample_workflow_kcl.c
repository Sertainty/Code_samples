/*! 
    ...
    \file     sample_workflow_kcl.c

    \brief    Sample program using C language interface.  Uses KCL to create ID.
...
int main(int argc, char *argv[])
{
  ...
  uxpfile_openNewFile(appHandle, uxpFileSpec, kclFileSpec,
                      KclFile, ModifierNoOptimize|ModifierReplace, 0);
