/******************************************************************************
 * This along with sample_auto_auth_text.h, these two files are generated from the secure text file sample_auto_auth_text.xml; demonstrates secure, in-memory, text strings.
 *
 * Encoded text
 *
...
void sample_auto_text_init()
{
  ...
  uxlmsg_loadSecureText(status, "Sample","sample_auto_auth_text.msg",key,key_size);
